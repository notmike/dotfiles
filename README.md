...
-----------------------------------------
 ...
 firefox        > custom css settings
 gdb            > general debugger settings
 ...
 nvim           > my main jam
 polybar        > fancy replacement for i3-blocks
 preview-pics   > unixporn screenshots
 qmk_keymap     > custom keyboard mappings (HHKB)
 qutebrowser    > minimal vim browser
 ranger         > file manager with image previews and z3bra theme
 scripts        > collection of handy dandy scripts
 termite        > awesome quick terminal emulator
 tmux           > multipane ssh / terminal
 vim            > wizard status bar and sourcerer color scheme
 wallpaper      > desktop backgrounds
 xorg-files     > sourcerer terminal colors and keyboard settings
 zathura        > minimal pdf reader w/ vim bindings
