...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [UTIL] = LAYOUT(
  ____, DYN_MACRO_PLAY1, DYN_MACRO_PLAY2, ____,    ____,    ____,   ____,    RESET,    ____,    ____,    ____, ____, TO(GAME), DF(UTIL), DEBUG, \
  ...
  ____, ____,           ____,           ____, ____, ____, ____, ____, ____, ____, ____, ____, ____,             \
    ...
    /* DEBUG Layer: Made to map debugging shortcuts to Fn keys. Can be repurposed.
     *
     * ,-------------------------------------------------------------.
     * |   |    |    |   |   |   |   |   |   |   |   |   |   |   |   |
     * |-------------------------------------------------------------|
  ...
  ____, ____, ____,   ____, KC_F1, ____, ____, KC_F2, KC_F3, KC_F4, KC_F5, ____, ____, ____,       \
  ____, ____, KC_F6, ____, KC_F7, ____, KC_F8, KC_F9, KC_F10, KC_F11, ____, ____, ____,             \
  ____, ____, ____,   ____, ____, ____, ____, ____, ____, ____, ____, ____, ____,             \
        ____, ____,   ____, ____, ____)
};
