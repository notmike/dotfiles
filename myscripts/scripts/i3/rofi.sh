...
rofi -modi "run,drun" -show drun -color-window "#282828,#282828" -color-normal "#282828,#ffffff,#282828,#282828,#b8bb26" -lines 8 -line-margin 5 -eh 1 -width 700 -padding 25 -location 0 -opacity "90" -bw 0 -font "Source Code Pro Semibold 10" -show-icons
