...
wget -Nrp -nd -A pdf -e robots=off 'http://www-cs.ccny.cuny.edu/~wes/CSC480F17/docs/hw/' -P /home/mg/Dropbox/School/City\ College/2017/2017\ Fall/CSC480-CompSecurity/hw
