...
if [[ -t 0 ]]; then
  ...
  SELECTION="$(echo "$C_HIST" | rofi -dmenu -i -color-window "#504945,#504945" -color-normal "#504945,#ffffff,#504945,#504945,#b8bb26" -lines 20 -line-margin 6 -eh 1 -width 1400 -padding 30 -location 0 -bw 0 -font "Fantasque Sans Mono 16" -p 'selection: ')"
fi
