...
rofi -modi "drun#emoji:/usr/bin/rofimoji#calc#run#window" -show drun -show emoji -color-window "#1d2021,#1d2021" -color-normal "#1d2021,#ffffff,#1d2021,#1d2021,#b8bb26" -lines 10 -line-margin 4 -eh 1 -width 800 -padding 30 -location 0 -bw 0 -font "Fantasque Sans Mono 15" -show-icons -no-show-match -no-sort
